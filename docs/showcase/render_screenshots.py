...
def shell(page,title,desc,right="Updated 19:24:56\nEvery 2 seconds"):
 ...
 rr(d,(18,13,44,39),6,ACCENT,ACCENT);txt(d,(31,26),"∿",17,"#071311",True,anchor="mm");txt(d,(54,26),"SystemPulse",15,TEXT,True,anchor="lm");txt(d,(151,26),"v09.4",12,MUTED,anchor="lm");txt(d,(238,26),"Hardware monitor",12,MUTED,anchor="lm")
